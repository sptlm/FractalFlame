...
public class AffineTransformTest {
    ...
    public void testAffineTransformApplication() {
        ...
        assertEquals(3, result[0], 0.001);
        assertEquals(5, result[1], 0.001);
    }
    ...
    public void testAffineTransformValidationWithSingularMatrix() {
        // Матрица с детерминантом = 0
        AffineTransform transform = new AffineTransform(1, 2, 0, 1, 2, 0);

        assertThrows(IllegalArgumentException.class, () -> ConfigValidator.validateAffineTransform(transform));
    }
    ...
    public void testAffineTransformValidation() {
        ...
        assertDoesNotThrow(() -> ConfigValidator.validateAffineTransform(transform));
    }
